...
def main():
    ...
    recog_cuts = load_manifest(args.res_dir / f"cuts_test.jsonl.gz")
    orig_cuts = load_manifest(args.manifest_dir / f"earnings21_cuts_normalized_feats.jsonl.gz")
    ...
    save_results(args.res_dir, "earnings21", results)
